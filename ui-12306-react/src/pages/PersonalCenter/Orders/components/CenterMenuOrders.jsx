import styles from './CenterMenuOrders.module.css'
import { Link } from 'react-router-dom'

export default function CenterMenuOrders({ activeGroup = 'orders', activeItem = 'train' }) {
  return (
    <ul className={`center-menu ${styles.menu}`} role="menubar">
      <li className="menu-item" role="menuitem">
        <h2 className={`menu-tit ${activeGroup==='overview'?styles.activeTit:''}`}><Link to="/center">个人中心</Link></h2>
      </li>
      <li className="menu-item" role="menuitem">
        <h2 className="menu-tit">订单中心<i className="icon icon-switch"></i></h2>
        <ul className="menu-sub" role="menubar">
          <li role="menuitem" className={activeGroup==='orders' && activeItem==='train' ? 'active' : ''}><Link to="/center/orders">火车票订单</Link></li>
      ...
      <li className="menu-item" role="menuitem">
        ...
        <ul className="menu-sub" role="menubar">
          <li role="menuitem" className={activeGroup==='profile' && activeItem==='view' ? 'active' : ''}><Link to="/center/profile">查看个人信息</Link></li>
      ...
      <li className="menu-item" role="menuitem">
        ...
        <ul className="menu-sub" role="menubar">
          <li role="menuitem" className={activeGroup==='common' && activeItem==='passengers' ? 'active' : ''}><Link to="/center/passengers">乘车人</Link></li>

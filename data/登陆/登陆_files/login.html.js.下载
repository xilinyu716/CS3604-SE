...
function esd_ZxdpublicwzaGz() {
	...
	$(".search-btn").attr("aria-label", "点击搜索");
	//语言-我的12306
...
function esd_wzaGz() { /* 改造代码开始 */
	$(function () {
		...
		$(".tempWrap li").each(function () {
			if ($(this).css("background-image").split("\"")[1] == "https://www.12306.cn/index/images/pic/banner-login-20200924.jpg") {
				$(this).find("a").attr("title", "铁路12306-中国铁路官方APP 尽享精彩出行服务");
			}
			if ($(this).css("background-image").split("\"")[1] == "https://www.12306.cn/index/images/pic/banner-login-20200924.jpg") {
				$(this).find("a").attr("title", "餐饮·特产 带有温度的旅途配餐");
			}
			if ($(this).css("background-image").split("\"")[1] == "https://www.12306.cn/index/images/banner-login.jpg") {
				$(this).find("a").attr("title", "餐饮·特产 带有温度的旅途配餐");
			}
			if ($(this).css("background-image").split("\"")[1] == "https://www.12306.cn/index/images/pic/banner-login-20200629.jpg") {
				$(this).find("a").attr("role","img").attr("aria-label", "中国铁路官方APP");
			}
		})
		//插入a元素的方法
		...
		$("#J-login-code-loading img").attr("alt", "加载中");
		$("#J-login-code-loading img").attr("aria-label", "加载中");
		$("#J-login-code-con #J-qrImg").attr("alt", "使用12306APP扫描本二维码进行登录");
		$("#J-login-code-con #J-qrImg").attr("aria-label", "使用12306APP扫描本二维码进行登录");
		$("#J-login-code-con .code-tips").attr("alt", "打开12306APP使用二维码扫描可进行登录");
		$("#J-login-code-con .code-tips").attr("aria-label", "打开12306APP使用二维码扫描可进行登录");
		esd_setinputTitle($("#J-userName"), "请输入用户名或邮箱或手机号");
		esd_setinputTitle($("#J-password"), "请输入密码");
		esd_setinputTitle($("a[href='https://exservice.12306.cn/excater/index.html']"), "餐饮·特产 带有温度的旅途配餐");

		$(".login-bd .login-code #J-login-code-con").prepend("<a href='javascript:' id='esd_JumptagA01' aria-label='使用12306APP扫描下方二维码进行登录' style='width:10px;height:10px;position:absolute;display:block;'></a>");
